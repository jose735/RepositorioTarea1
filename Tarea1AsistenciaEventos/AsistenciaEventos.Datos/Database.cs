...
namespace AsistenciaEventos.Datos
{
    ...
    {
        /*IDisposable permite a los objetos liberar los recursos que tengan correctamente 
         * y de forma determinista. 
         * Si en el código anteriorprodujese una excepción se corre el riesgo de no liberar
         * los recursos. 
