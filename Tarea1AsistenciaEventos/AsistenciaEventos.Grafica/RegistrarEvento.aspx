...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <div class="row form-group">
            <div class="col-sm-2 col-md-8">
                <asp:GridView ID="dgvEventos" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="codigo" AutoGenerateColumns="false" AutoGenerateEditButton="true" AutoGenerateDeleteButton="true" OnRowCancelingEdit="dgvEventos_RowCancelingEdit" OnRowDeleting="dgvEventos_RowDeleting" OnRowEditing="dgvEventos_RowEditing" OnRowUpdating="dgvEventos_RowUpdating" OnRowDataBound="dgvEventos_RowDataBound">
